...
def fb_canhan(browser,link_cookies='/home/ds1/vosint/v-osint-backend/vosint_ingestion/facebook/cookies.json',link_person = ''):
    data = {}
#with sync_playwright()as p:
    ...
    def select(from_element, expr, by = "css="):
        ...
        return element
    person = select(page,"section")
    person = select(person[0],"article")
    datas = []
    for i in range(len(person)):
        data = {}
        data['id'] = link_person.replace('https://','').replace('mbasic.facebook.com/','')
